...
public class ProductServiceMysql implements IProductService{
    ...
    private static final String SAVE_PRO = "INSERT INTO `products` (`name`, `description`, `price`, `createAt`, `id_category`) VALUES (?, ?, ?, ?, ?);";
    ...
    private static final String UPDATE_PRO = "UPDATE `products` SET `name` = ?, `description` = ?, `price` = ?, `createAt` = ?, `id_category` = ? WHERE (`id` = ?);";
    ...
    public List<Product> findAll() {
        ...
        try{
            ...
            while (rs.next()){
                ...
                Product product = new Product(id, name, description, price, createAtL );
    ...
    public Product findById(long id) {
        try {
            ...
            while (rs.next()){
                ...
                java.sql.Date createAt = rs.getDate("createAt");
                LocalDate createAtL = createAt.toLocalDate();
                Product product = new Product(idProduct, name, description, price, createAtL);
